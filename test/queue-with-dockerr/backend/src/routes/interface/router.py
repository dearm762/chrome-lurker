...
async def get_client_ticket(
    ...
    # Определить количество тикетов в очереди перед текущим тикетом
    ...
    # Найти текущий тикет, который обрабатывается работником в этой категории
...
async def get_user_information(
    ...
    # Format the created_at field for each ticket
    formatted_tickets = []
